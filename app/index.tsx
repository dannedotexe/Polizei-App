...
export default function ChatScreen() {
  ...
  function sendMessage() {
    ...
    const newSighting: Sighting = {
      ...
      latitude: 48.4539 + (Math.random() - 0.5) * 0.1,
      longitude: 13.4347 + (Math.random() - 0.5) * 0.1,
      timestamp: new Date(),
  ...
  function renderItem({ item }: { item: Sighting }) {
    ...
    const typeLabel = PATROL_TYPE_LABELS[item.patrolType];
          ...
          <View style={styles.modalSheet}>
            ...
            {patrolTypes.map((type) => (
              <TouchableOpacity
                ...
                style={[
                  styles.modalOption,
                  selectedType === type && styles.modalOptionActive,
                ]}
                onPress={() => {
